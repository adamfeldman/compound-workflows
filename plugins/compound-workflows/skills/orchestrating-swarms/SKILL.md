...
description: Orchestrate multi-agent swarms — parallel reviews, pipelines, task queues
...
From the `compound-workflows` plugin (examples):

### Review Agents
```javascript
// Security review
Task({
  subagent_type: "compound:review:security-sentinel",
...
// Performance review
Task({
  subagent_type: "compound:review:performance-oracle",
...
// Architecture review
Task({
  subagent_type: "compound:review:architecture-strategist",
...
// Code simplicity
Task({
  subagent_type: "compound:review:code-simplicity-reviewer",
  description: "Simplicity check",
  prompt: "Check if this implementation can be simplified"
})
```

**All review agents from compound:**
...
- `frontend-races-reviewer` - JavaScript race conditions
...
Task({
  subagent_type: "compound:research:best-practices-researcher",
...
Task({
  subagent_type: "compound:research:framework-docs-researcher",
...
Task({
  subagent_type: "compound:research:git-history-analyzer",
...
```javascript
Task({
  subagent_type: "compound:workflow:bug-reproduction-validator",
