...
assistant: "I've implemented the controller. Now let me take a look at possible race conditions and DOM irregularities."
<commentary>
...
<commentary>
After modifying existing Stimulus controllers, especially things concerning time and asynchronous operations, use frontend-races-reviewer to ensure the changes are free of UI races in JavaScript code.
</commentary>
</example>
</examples>
