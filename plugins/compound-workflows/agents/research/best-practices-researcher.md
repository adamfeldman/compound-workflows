...
2. **Organize Discoveries**:
   ...
   - Clearly indicate source: "From skill: agent-native-architecture" vs "From official docs" vs "Community consensus"
...
- **Skill-based**: "The agent-native-architecture skill recommends..." (highest authority - curated)
