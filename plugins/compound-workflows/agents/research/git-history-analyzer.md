...
Note that files in `docs/plans/` and `docs/solutions/` are compound-workflows pipeline artifacts created by `/compound:plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
